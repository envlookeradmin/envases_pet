  ...
  - name: ''
    ...
    body_text: |
      <table style="width: 100%;">
          <tbody>
              <tr>
                  <td style="width: 33.3333%;" rowspan="2"><img src="https://looker.isrstoreintelligence.online/Logo_Envases.jpg" width="202" height="80"></td>
                  <td style="width: 38.4291%;">
                      <div style="text-align: center;"><strong><span style="font-size: 22px;">Divisi&oacute;n PET&nbsp;</span></strong></div>
                  </td>
                  <td style="width: 28.2376%;" rowspan="2"><img src="https://looker.isrstoreintelligence.online/ENVASES.jpg"  width="60" height="60"></td>
              </tr>
              <tr>
                  <td style="width: 38.4291%;">
