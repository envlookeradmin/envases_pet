- dashboard: envases_pet_cliente
  title: ENVASES PET CLIENTE
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: VhQta1KDmhyYh2G59rk1Os
  elements:
  - title: Ventas por Cliente
    ...
    explore: rpt_mx_vtas
    type: looker_grid
    fields: [rpt_mx_vtas.client, rpt_mx_vtas.planta_desc, rpt_mx_vtas.category, rpt_mx_vtas.DIA,
      rpt_mx_vtas.VS_LY, rpt_mx_vtas.MTD, rpt_mx_vtas.VS_LY_1, rpt_mx_vtas.YTD, rpt_mx_vtas.VS_LY_2,
      rpt_mx_vtas.DIA_anterior, rpt_mx_vtas.MTD_yl, rpt_mx_vtas.YTD_anterior]
    filters:
      rpt_mx_vtas.category: "-Total mxn"
    sorts: [rpt_mx_vtas.client, rpt_mx_vtas.planta_desc, rpt_mx_vtas.category, rpt_mx_vtas.DIA
        desc]
    subtotals: [rpt_mx_vtas.client, rpt_mx_vtas.planta_desc]
    limit: 5000
    column_limit: 50
    total: true
    ...
    series_column_widths:
      grouped-column-rpt_mx_vtas.category: 197
      rpt_mx_vtas.category: 120
      rpt_mx_vtas.client: 180
      rpt_mx_vtas.VS_LY: 70
      rpt_mx_vtas.MTD: 70
